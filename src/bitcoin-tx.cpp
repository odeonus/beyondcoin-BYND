...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " beyondcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  beyondcoin-tx [options] <hex-tx> [commands]  Update hex-encoded beyondcoin transaction\n" +
            "or:     beyondcoin-tx [options] -create [commands]   Create hex-encoded beyondcoin transaction\n" +
            "\n";
