...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s beyondcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  beyondcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded beyondcoin transaction") + "\n" +
              "  beyondcoin-tx [options] -create [commands]   " + _("Create hex-encoded beyondcoin transaction") + "\n" +
              "\n";
