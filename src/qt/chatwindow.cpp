...
ChatboxPage::ChatboxPage(QWidget *parent) : QWidget(parent), ui(new Ui::ChatboxPage)
{
...
void ChatboxPage::on_loginButton_clicked()
{
  int pass=0;
...
void ChatboxPage::on_logoutButton_clicked()
{
...
void ChatboxPage::on_sayButton_clicked()
{
...
void ChatboxPage::disconnected()
{
  // Flip over to the chat page:
  ui->stackedWidget->setCurrentWidget(ui->loginPage);
}

void ChatboxPage::saveSettings()
{
  QSettings settings("Bitcoin-sCrypt", "settings");
