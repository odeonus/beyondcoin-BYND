...
UniValue getblockheader(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw std::runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("getblockheader", "\"e4c23a189582c0a7719569717bfeb59b478a20367c5b36dd6fb18b7df4ecab51\"")
            + HelpExampleRpc("getblockheader", "\"e4c23a189582c0a7719569717bfeb59b478a20367c5b36dd6fb18b7df4ecab51\"")
        );
...
UniValue getblock(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw std::runtime_error(
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("getblock", "\"e4c23a189582c0a7719569717bfeb59b478a20367c5b36dd6fb18b7df4ecab51\"")
            + HelpExampleRpc("getblock", "\"e4c23a189582c0a7719569717bfeb59b478a20367c5b36dd6fb18b7df4ecab51\"")
        );
...
UniValue gettxout(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 3)
        throw std::runtime_error(
            ...
            "     \"addresses\" : [          (array of string) array of beyondcoin addresses\n"
