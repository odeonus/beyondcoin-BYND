...
public:
    CMainParams() {
        ...
        consensus.nMinimumChainWork = uint256S("0x000000000000000000000000000000000000000000000000000fe1328cd2e5bc");

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x51f9cd1ae434797273ea21708c710f5862079b6a5f06dae8352309139cc6ee4e"); // 24550
        ...
        vSeeds.emplace_back("dnsseed.beyonddata.llc");
        vSeeds.emplace_back("bynd-main-dns1.beyonddata.llc");
        ...
        chainTxData = ChainTxData{
            // Data as of block 51f9cd1ae434797273ea21708c710f5862079b6a5f06dae8352309139cc6ee4e (height 24550).
            /* nTime    */ 1571462792,
            /* nTxCount */ 25409,
            /* dTxRate  */ 0.029
        };
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.beyonddata.llc");
        vSeeds.emplace_back("bynd-test-dns1.beyonddata.llc");
