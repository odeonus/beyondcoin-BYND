...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.beyondcoin.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.beyondcointools.com", true);
        vSeeds.emplace_back("dnsseed.beyondcoinpool.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.beyondcointools.com", true);
        vSeeds.emplace_back("seed-b.beyondcoin.loshan.co.uk", true);
