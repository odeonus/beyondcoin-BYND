...
Output from `gbuild` will look something like
    ...
    From https://github.com/beyondcoin-project/beyondcoin
...
[beyondcoin-project/gitian.sigs.bynd](https://github.com/beyondcoin-project/gitian.sigs.bynd/) repository, or if that's not possible create a pull
