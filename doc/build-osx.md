...
1. Clone the Beyondcoin Core source code:
...
Before running, you may create an empty configuration file:
    ...
    mkdir -p "/Users/${USER}/Library/Application Support/Beyondcoin"

    touch "/Users/${USER}/Library/Application Support/Beyondcoin/beyondcoin.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/Beyondcoin/beyondcoin.conf"

The first time you run beyondcoind, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
