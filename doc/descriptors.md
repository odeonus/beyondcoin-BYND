# Support for Output Descriptors in Beyondcoin Core

Since Beyondcoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `bynd1...` for mainnet or `tbynd1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Beyondcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Beyondcoin Core wallets, a convenience function `combo` is
