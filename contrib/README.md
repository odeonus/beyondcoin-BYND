...
### [RPM](/contrib/rpm) ###
RPM spec file for building bbeyondcoin-core on RPM based distributions.
...
This script attempts to download and verify the signature file SHA256SUMS.asc from beyondcoin.io.
