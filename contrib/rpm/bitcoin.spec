...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 10332
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 10333
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 14332
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 14333
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 11332
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 11333
...
if [ $1 -eq 0 ]; then
	if [ `%{_sbindir}/sestatus |grep -c "disabled"` -eq 0 ]; then
	%{_sbindir}/semanage port -d -p tcp 10332
	%{_sbindir}/semanage port -d -p tcp 10333
	%{_sbindir}/semanage port -d -p tcp 14332
	%{_sbindir}/semanage port -d -p tcp 14333
	%{_sbindir}/semanage port -d -p tcp 11332
	%{_sbindir}/semanage port -d -p tcp 11333
	for selinuxvariant in %{selinux_variants}; do
