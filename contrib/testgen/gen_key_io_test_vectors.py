...
bech32_templates = [
  ...
  ('bynd',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('bynd',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('bynd',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tbynd',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tbynd',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tbynd',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rbynd',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rbynd',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rbynd', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tbynd',  17, 32, False, False, False),
  ('rbynd',  3,  1, False, False, False),
  ('bynd',   15, 41, False, False, False),
  ('tbynd',  0, 16, False, False, False),
  ('rbynd',  0, 32, True,  False, False),
  ('bynd',   0, 16, True,  False, False),
  ('tbynd',  0, 32, False, True,  False),
  ('rbynd',  0, 20, False, False, True)
]
