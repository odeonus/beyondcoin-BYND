...
"""Verify that starting beyondcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start beyondcoin with -h for help text")
        ...
        self.log.info("Start beyondcoin with -version for version information")
        ...
        self.log.info("Start beyondcoind with -fakearg to make sure it does not start")
